Cập nhật mã JavaScript để xử lý việc thay đổi quyền hạn trong cửa sổ modal.
Sửa mã JavaScript của bạn để bao gồm một tham số mới cho quyền hạn(role) khi mở cửa sổ modal và cập nhật quyền hạn khi lưu thay đổi.Dưới đây là cách bạn có thể sửa mã nguồn JavaScript:
