...
--	CONSTRAINT FK_BILLDETAIL_PRODUCT FOREIGN KEY (IDPRO) REFERENCES PRODUCT(IDPRO),
--)
INSERT INTO [ORDER] VALUES ('chinhchinhdemo@gmail.com', N'119', GETDATE(), GETDATE(),GETDATE(), null, 3100000)
DECLARE @ORDER_ID int; SET @ORDER_ID = SCOPE_IDENTITY();
INSERT INTO ORDERDETAIL VALUES (@ORDER_ID, 1, 1)
INSERT INTO ORDERDETAIL VALUES (@ORDER_ID, 2, 1)
INSERT INTO ORDERDETAIL VALUES (@ORDER_ID, 3, 1)
INSERT INTO ORDERDETAIL VALUES (@ORDER_ID, 4, 1)
